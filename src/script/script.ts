...
// type breakfast = "Signature Breakfast" | "Pancakes" | "Egg Toast";
// type meal = "Classic Burger" | "Fried Chicken" | "Spaghetti";
// type sides = "Chicken Tenders" | "Fries" | "Fish and Chips";
// type drinks = "Strawberry Milkshake" | "Choco Smoothie" | "Mango Shake";
...
// export type Menu = keyof wholeMenu | "All"
...
//         <div class="flex justify-center items-center m-10">${listing.title}</div>
